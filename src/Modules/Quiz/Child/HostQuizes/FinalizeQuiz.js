            ...
            >
                  <View style={externalStyle.container}>
                    <Card containerStyle={externalStyle.mainCardF}>
                        ...
                        >
                            <Text style={externalStyle.firstCardTextF}>Created:    {` ${moment(props.finalizeQuiz.creationDate).format("lll")}`}</Text>
                            <Text style={externalStyle.firstCardTextF}>Questions:  {`${props.finalizeQuiz.noOfQuestions || ""}`}</Text>
                            <Text style={externalStyle.firstCardTextF}>Categories: {`${props.finalizeQuiz.categoryName || ""}`}</Text>
                        </Card>
                        ...
                        <View style={{ flexDirection: 'row', alignSelf:'center',marginTop:'5%', }}>
                            ...
                            <Button
                                ...
                                containerStyle={externalStyle.containerStyleFP}
                                buttonStyle={externalStyle.buttonStyleHP}
                               // onPress={() => props.navigation.navigate('Update Quiz Name')}
                            />
                        </View>
                        <Button
