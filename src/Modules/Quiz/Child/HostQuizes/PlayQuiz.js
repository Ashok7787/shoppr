...
function PlayQuiz(props) {
    ...
    const shareMessage = () =>{
        Share.share({
            message:`http://player.quizledge.no${props.finalizeQuizUrl.quizLink || ""}`
            // props.finalizeQuizUrl.quizLink.toString(),
        })
                   ...
                   // containerStyle={styles.mainCard}
                    >
                       ...
                       <Text style={externalStyle.headplayquizhost}>
                        ...
                        >
                            <Text style={externalStyle.firstCardText}>{`http://player.quizledge.no${props.finalizeQuizUrl.quizLink || ""}`}</Text>
                        </Card>
